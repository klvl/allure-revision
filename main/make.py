...
def main():
    ...
    spreadsheet.collect_column_formatting_requests(sheet_id, data.columns, rows)
    spreadsheet.collect_header_formatting_request(sheet_id, data.header_formatting, data.columns)
