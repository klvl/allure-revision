...
AVAILABLE_REPORT_VALUES = ['name', 'fullName', 'package', 'epic', 'feature', 'shortMessage', 'message', 'stepFailed',
                           'category', 'status', 'durationMs', 'durationSec', 'durationMin', 'durationHrs']
